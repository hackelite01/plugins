...
async def _(event):
   ...
   -馃敄ID : **`{}`
   **-**馃懃**Groups in Common : **`{}`
   **-**馃審**Data Centre Number : **`{}`
   **-**馃攺**Restricted by telegram : **`{}`
   **-**馃{}
   **-**馃懏鈥嶁檪锔弡}
""".format(
        first_name,
...
async def fetch_info(replied_user, event):
    ...
    caption += f"<b>馃懁 First Name:</b> {first_name} {last_name}\n"
    caption += f"<b>馃さ Username:</b> {username}\n"
    caption += f"<b>馃敄 ID:</b> <code>{user_id}</code>\n"
    caption += f"<b>馃審 Data Centre ID:</b> {dc_id}\n"
    caption += f"<b>馃柤 Number of Profile Pics:</b> {replied_user_profile_photos_count}\n"
    caption += f"<b>馃 Is Bot:</b> {is_bot}\n"
    caption += f"<b>馃攺 Is Restricted:</b> {restricted}\n"
    caption += f"<b>馃寪 Is Verified by Telegram:</b> {verified}\n\n"
    caption += f"<b>鉁嶏笍 Bio:</b> \n<code>{user_bio}</code>\n\n"
    caption += f"<b>馃懃 Common Chats with this user:</b> {common_chat}\n"
    caption += f"<b>馃敆 Permanent Link To Profile:</b> "
...
CMD_HELP.update(
    {
        "whois": "**Plugin : **`whois`\
    \n\n  鈥�  **Syntax : **`.whois <username> or reply to someones text with .whois`\
    \n  鈥�  **Function : **__Gets info of an user.__\
    \n\n  鈥�  **Syntax : **`.userinfo <username> or reply to someones text with .userinfo`\
    \n  鈥�  **Function : **__Gets information of an user such as restrictions ban by spamwatch or cas__\
    \n\n  鈥�  **Syntax : **`.link id/username/reply`\
    \n  鈥�  **Function : **__Generates a link to the user's PM .__"
    }
)
