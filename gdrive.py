# Skulluserbot Google Drive managers  ported from Projectbish and added extra things by @mayank1rajput
...
async def upload(gdrive, service, file_path, file_name, mimeType):
    ...
    body = {
        "name": file_name,
        "description": "Uploaded from Telegram using Skulluserbot.",
        "mimeType": mimeType,
    }
    try:
        if parent_Id is not None:
