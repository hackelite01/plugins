...
KANGING_STR = [
    ...
    "Dekh kya raha hai hehe...",
    "Inviting this sticker over to my pack...",
    "Kanging this sticker...",
    "Hey that's a nice sticker!\nMind if I kang?!..",
    "hehe mene sticker kang krliya\nhehe.",
    "Ay or aap kuch na kar dake lol\nso meme kang kar raha hu.....",
...
async def pack_kang(event):
    ...
    for i in enumerate(blablapacks):
        result += f"   1�7  [pack {blablapacknames[i]}](t.me/addstickers/{blablapacks[i]})"
...
\n\n**   1�7  Syntax : **`.kang [emoji('s)] [number]`\
\n**   1�7  Function : **__Kang's the sticker/image to the specified pack and uses the emoji('s) you picked.__\
\n\n**   1�7  Syntax : **`.pkang [number]`\
\n**   1�7  Function : **__Kang's the entire sticker pack of replied sticker to the specified pack __\
\n\n**   1�7  Syntax : **`.stickers name`\
\n**   1�7  Function : **__shows you the list of non-animated sticker packs with that name.__\
\n\n**   1�7  Syntax : **`.stkrinfo`\
\n**   1�7  Function : **__Gets info about the sticker pack.__"
    }
)
