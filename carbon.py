...
async def carbon_api(e):
    ...
    await skull.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await skull.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
async def carbon_api(e):
    ...
    await skull.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await skull.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await skull.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await skull.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await skull.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await skull.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await skull.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await skull.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await skull.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await skull.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
